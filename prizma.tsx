...
const TriviaGame = () => {
  ...
  const generateQuestions = async () => {
    ...
    try {
      ...
      const prompt = `Tam olarak ${numQuestions} adet Türkçe bilgi yarışması sorusu oluştur. Şu özellikler olsun:
- Kategoriler: ${categoriesStr}
- Zorluk seviyesi: ${difficulty}
- Format: 4 seçenekli çoktan seçmeli
- Türkiye ve Türk kültürü hakkında sorular ekle
- Tüm sorular ve seçenekler Türkçe olsun
...
Her sorunun tam 4 makul seçeneği olsun ve correctAnswer doğru seçeneğin indeksi (0-3) olsun.
JSON DIŞINDA HİÇBİR ŞEY YAZMA. Yanıtının tamamı tek bir geçerli JSON objesi olmalı.`;
